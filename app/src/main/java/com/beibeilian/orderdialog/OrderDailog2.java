...
//		showDialog("正在获取订单...");
		...
		if (alipayOrWechatPay){
            LIUPayTools.getInstance().startPay(OrderDailog2.this,PAY_TYPE_ALI,"pay198_"+System.currentTimeMillis(), price, "VIP", "http://www.baidu.com", "709", new IPayResult() {
				@Override
            ...
            LIUPayTools.getInstance().startPay(this,ZYPayTools.PAY_TYPE_WX,"pay198_"+System.currentTimeMillis(), price, "VIP", null, "709", new IPayResult() {
				@Override
				public void PayResult(boolean isPay) {
					if(isPay){
						try {
